...
export const metadata: Metadata = {
  ...
  description: "Vítejte v chovatelské stanici White Line Czech. Specializujeme se na chov bílého švýcarského ovčáka, corgi a německého ovčáka. Nabízíme štěňata s PP.",
  keywords: ["bílý švýcarský ovčák", "chovatelská stanice", "německý ovčák", "ovčák", "corgi", "štěňata", "štěňata s PP", "whiteline", "whiteline czech","BŠO", "chov psů"],
  ...
  openGraph: {
    ...
    description: "Profesionální chov bílého švýcarského ovčáka. Štěňata s PP, chovatelský servis a poradenství.",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "description": "Specializujeme se na chov bílého švýcarského ovčáka, corgi a německého ovčáka. Nabízíme štěňata s PP.",
    "address": {
      "@type": "PostalAddress",
      addressCountry: "CZ",
    },
